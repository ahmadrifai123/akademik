                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="pages/widgets.html">
                                <i class="fa fa-th"></i> <span>Referensi</span> <small class="badge pull-right bg-green"></small>
                            </a>
                        </li>

                           <li>
                            <a href="pages/widgets.html">
                                <i class="fa fa-th"></i> <span>Guru & Pelajaran</span> <small class="badge pull-right bg-green"></small>
                            </a>
                        </li>

                           <li>
                            <a href="pages/widgets.html">
                                <i class="fa fa-th"></i> <span>PSB</span> <small class="badge pull-right bg-green"></small>
                            </a>
                        </li>

                           <li>
                            <a href="pages/widgets.html">
                                <i class="fa fa-th"></i> <span>Kesiswaan</span> <small class="badge pull-right bg-green"></small>
                            </a>
                        </li>

                           <li>
                            <a href="pages/widgets.html">
                                <i class="fa fa-th"></i> <span>jadwal & Kalender</span> <small class="badge pull-right bg-green"></small>
                            </a>
                        </li>

                           <li>
                            <a href="pages/widgets.html">
                                <i class="fa fa-th"></i> <span>Mutasi</span> <small class="badge pull-right bg-green"></small>
                            </a>
                        </li>
